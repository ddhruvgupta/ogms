...
if(isset($_POST['add_advisor']) ){
  ...
  */ 
  ...
  if($count >=2){
   ...
   $statement = $pdo->prepare($sql);
   $statement->execute(array(':pantherid'=>$_POST['pantherid'],':email'=>$user_email,':lastModified'=>$date));
   $_SESSION['insert'] = 'Advisor Successfully Assigned';
   header("Location: newStudent.php");
   return;
 }
...
<html lang="en">
<!-- Header -->
<?php include $root.'/links/header.php';?>
<!-- /#Header -->
<body>
  <!-- Navigation -->
  <?php include $root.'/UI/staff/staffmenu.php';?>
  <!-- /#Navigation -->
